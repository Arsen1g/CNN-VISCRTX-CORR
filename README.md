...
Understanding how **deep neural networks (DNNs)** represetationally align with human visual processing is a key question in **computational neuroscience** and **NeuroAI**. This work connects to broader questions about the **"common currency"** of AI **interpretability** and **biological plausibility** of DNN/CNN architectures.

## Regions of Interest

This table summarizes approximate onset latencies for human visual cortical areas following stimulus presentation. Latencies are based on EEG, MEG, and intracranial EEG studies.
